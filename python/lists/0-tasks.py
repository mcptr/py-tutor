...
# 5. Print the sum of all the elements
# 6. Print the sum of all even elements
# 7. Print the max element
# 8. Print the min element
# 9. Print the number of unique elements
# 10. Insert a number 6 at sixth position
